...
HD_PWD='C:/Users/clare/Desktop/Lab2_Wed_PM_CLARENCE POH XIANG JUN_144_Archive/Assignment2/Assignment2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log assignment2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source assignment2.tcl
